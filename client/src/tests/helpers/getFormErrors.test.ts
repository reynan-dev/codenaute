import { CONFIRMED_PASSWORD_ERROR_MESSAGE, INVALID_EMAIL_ERROR_MESSAGE, PASSWORD_FORMAT_ERROR_MESSAGE, USERNAME_MUST_BE_LONG_ERROR_MESSAGE } from "constants/errorMessages";
